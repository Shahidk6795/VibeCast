...
const Atif = () => {
  ...
  const playlist = [
    ...
    { name: "Tera Hone Laga Hoon", path: TeraHoneLagaHoon, image: TeraHoneLagaHoonImg, durationDisplay: "4:10" },
    { name: "Piya O Re Piya", path: PiyaORePiya, image: PiyaORePiyaImg, durationDisplay: "4:22" },
    { name: "Tera Hua", path: TeraHua, image: TeraHuaImg, durationDisplay: "4:15" },
    { name: "O Saathi", path: OSaathi, image: OSaathiImg, durationDisplay: "4:05" },
    { name: "Jeena Jeena", path: JeenaJeena, image: JeenaJeenaImg, durationDisplay: "3:55" },
    { name: "Dekhte Dekhte", path: DekhteDekhte, image: DekhteDekhteImg, durationDisplay: "4:07" },
    { name: "Tu Jaane Na", path: TuJaaneNa, image: TuJaaneNaImg, durationDisplay: "4:30" },
    { name: "Be Intehaan", path: BeIntehaan, image: BeIntehaanImg, durationDisplay: "4:25" },
    { name: "Tajdar E Haram", path: TajdarEHaram, image: TajdarEHaramImg, durationDisplay: "5:30" },
    { name: "Pehli Dafa", path: PehliDafa, image: PehliDafaImg, durationDisplay: "4:10" },
    { name: "Tere Bin", path: TereBin, image: TereBinImg, durationDisplay: "4:00" },
  ];
  ...
  return (
    <div className="min-h-screen text-white flex flex-col items-center overflow-hidden bg-black">
      <div className="w-full h-80 pt-16 relative bg-gradient-to-b from-[#1db954] to-black shadow-lg">
        ...
        <div className="flex items-end max-w-5xl mx-auto h-full px-6 pb-8">
          <img src={atifImg} alt="Atif Aslam" className="w-56 h-56 shadow-2xl object-cover rounded-full mr-6 border-4 border-gray-900/50" />
          <div>
            <p className="text-sm font-bold uppercase text-white/80">Artist</p>
            <h1 className="text-7xl font-black mb-1">Atif Aslam</h1>
            <p className="text-md font-semibold text-white/70 mt-2">14 songs • Voice of Love and Emotions.</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full min-h-screen relative z-10 pt-8 px-6 pb-24">
        <div className="max-w-5xl mx-auto relative z-20">
          <div className="flex items-center mb-6">
            <button onClick={playPause} className="w-16 h-16 rounded-full bg-[#1db954] text-black flex items-center justify-center shadow-2xl hover:scale-105 transition-transform">
              {isPlaying ? (
        ...
        <div className="fixed bottom-0 left-0 right-0 h-24 bg-gray-800/95 backdrop-blur-sm z-50 flex items-center justify-between px-4 shadow-2xl">
          <div className="flex items-center w-1/4 min-w-[200px]">
            ...
            <div className="flex flex-col truncate">
              ...
              <span className="text-xs text-gray-400">Atif Aslam</span>
            </div>
          </div>
          <div className="flex flex-col items-center w-1/2 max-w-lg">
            <div className="flex gap-6 mb-1 items-center">
              ...
              <button onClick={playPause} className="w-8 h-8 rounded-full bg-[#1db954] text-black flex items-center justify-center hover:scale-105 transition-transform">
                {isPlaying ? (
            ...
            <div className="w-full flex items-center gap-2 text-xs text-gray-400">
              ...
              <div className="w-full h-1 bg-gray-600 rounded-full cursor-pointer group" onClick={seek}>
                <div className="h-1 bg-[#1db954] rounded-full relative" style={{ width: `${(progress / (duration || 1)) * 100}%` }}>
