...
const Pritam = () => {
  ...
  const playlist = [
    ...
    { name: "Lut Put Gaya", path: LutPutGaya, image: LutPutGayaImg, durationDisplay: "3:40" }, // Replaced Banda
        ...
        <div className="fixed bottom-0 left-0 right-0 h-24 bg-gray-800/95 backdrop-blur-sm z-50 flex items-center justify-between px-4 shadow-2xl">
          ...
          <div className="flex flex-col items-center w-1/2 max-w-lg">
            <div className="flex gap-6 mb-1 items-center">
              ...
              <button onClick={playPause} className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center hover:scale-105 transition-transform">
                {isPlaying ? (
